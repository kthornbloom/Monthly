...
(function($) {
    $.fn.extend({
        monthly: function(options) {
            ...
            const _CONST_DEFAULT_LOCALE_KEY = 'en';
            ...
            const _CONST_LOCALE_KEY = (options != undefined && options.monthNames != undefined) ? options.monthNames : _CONST_DEFAULT_LOCALE_KEY;
            ...
            function setMonthly(m, y) {
                ...
                if (setMonth == currentMonth && setYear == currentYear) {
                    ...
                    $('#' + uniqueId + ' .monthly-header-title').html('<a href="#" class="monthly-header-title-date"  onclick="return false">' + monthNames[m - 1] + ' ' + y + '</a><a href="#" class="monthly-reset" title="Set to today">↻ '+ _CONST_LOCALES[_CONST_LOCALE_KEY].today +'</a> ');
                }
